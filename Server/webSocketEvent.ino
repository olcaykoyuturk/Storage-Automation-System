  ...
  switch (type) {
    ...
    case WS_EVT_DATA: {
      ...
      if (msg.startsWith("ID:") && msg.indexOf(">>") == -1 && msg.indexOf("TARGET:") == -1) {
        ...
        // Görev atama işlemini çağır ve koordinatları ileterek güncelle
        ...
        if (command == "LOAD_COMPLETE" && client.state == PICKING) {
          ...
          client.targetX = 0; // Ana üs konumu
          client.targetY = 0;
...
// Log mesajlarını web sayfasına gönder
...
// Client bilgilerini broadcast et
